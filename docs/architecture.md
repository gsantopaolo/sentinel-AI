...
flowchart LR
    ...
    subgraph ServicesLeft["Services"]
      direction TB
      scheduler[[scheduler]](docs/scheduler.md):::service
      connector[[connector]](docs/connector.md):::service
      filter[[filter]](docs/filter.md):::service
    end
    ...
    subgraph ServicesRight["Services"]
      direction TB
      ranker[[ranker]](docs/ranker.md):::service
      inspector[[inspector]](docs/inspector.md):::service
      api[[api]](docs/api.md):::service
      web[[web (UI)]](readme.md):::service
      guardian[[guardian]](docs/guardian.md):::service
    end
...
| [**inspector**](./inspector.md) | Detects anomalous or fake IT news and flags them in the datastore                                    | Subscribe to `filtered.events`; detect anomalies/fake news; update anomaly flag on the corresponding Qdrant record; ack only on success                                                                                                                                                                                                                 | –                                                | `filtered.events`                                                           |
...
| [**web**](../readme.md)       | User-facing web application for visualizing and interacting with the newsfeed                        | Render dashboards and lists; call API endpoints (`/news*`, `/sources*`, `/ingest`, `/retrieve`, etc.); provide UI controls for reranking and CRUD ops                                                                                                                                                                                                   | –                                                | HTTP API endpoints on `api`                                                 |
